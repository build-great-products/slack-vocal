...
import type { MessageCounts, SlackConfig, UserInfo } from './types'
import {
  getLastSyncTime,
  updateLastSyncTime,
  saveMessageCounts,
...
async function fetchUserMessages(config: SlackConfig): Promise<void> {
...
export { fetchUserDetails, fetchUserMessages }
